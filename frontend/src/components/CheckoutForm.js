...
const CheckoutForm = (params) => {
  ...
  const handleSubmit = async (event) => {
    ...
    await axios({method:'post',url:'http://localhost:5000/individualTrainee/checkBeforeProceed',withCredentials:true,data:{
            ...
            const result = await stripe.confirmPayment({
              ...
              confirmParams: {
                ...
                const addCourse = async () =>{
                    await axios({method:'post',url:'http://localhost:5000/individualTrainee/payWithCard',withCredentials:true,data:{
